...
class UserSecurityProvider implements UserProviderInterface, PasswordUpgraderInterface
{
    ...
    public function loadUserByIdentifier(string $identifier): UserInterface
    {
        ...
        $userSecurity->setAccessToken($user->getAccessToken());
    ...
    {
        if (!$user instanceof UserSecurityEntity) {
    ...
    {
        return UserSecurityEntity::class === $class || is_subclass_of($class, UserSecurityEntity::class);
    }
